...
print "<B>Tier Roster</B>";
print "</A><br>";
print "<A HREF=\"30daybreakdown.shtml\" STYLE=\"text-decoration:none\">";
print "<B>30 Day Breakdown</B>";
print "</A><br>";
print "<A HREF=\"60daybreakdown.shtml\" STYLE=\"text-decoration:none\">";
print "<B>60 Day Breakdown</B>";
print "</A><br>";
...
print "<B>All Loot</B>";
print "</A><br>";
print "<A HREF=\"bis_lists.shtml\" STYLE=\"text-decoration:none\">";
print "<B>BIS Lists</B>";
print "</A><br>";
print "<A HREF=\"zones.shtml\" STYLE=\"text-decoration:none\">";
print "<B>Zones</B>";
print "</A><br>";
#print "<A HREF=\"http://legiontracker.com/mychat/index.php\" STYLE=\"text-decoration:none\">";
#print "<B>**Chat</B>";
#print "</A><br>";
